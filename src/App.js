...
function App() {
  ...
  function downloadSvg() {
    saveSvgAsPng.saveSvgAsPng(document.getElementById("mystery-tile"), "mystery.png");
  }
  ...
  return (
    <div className="App">
      ...
      />
      <div id="input-list">
        <button onClick={downloadSvg} onMouseEnter={(e) => addButtonHighlight(e.target)} onMouseLeave={(e) => removeButtonHighlight(e.target)}>Download PNG</button>
        <div className="name">
